...
```bash
g++ -std=gnu++17 src/main.cpp src/CommitManager.cpp src/HashingHelper.cpp src/Logviewer.cpp src/Repository.cpp src/Restore.cpp src/CommitNode.cpp -I include -o minigit.exe
